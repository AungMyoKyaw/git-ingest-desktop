...
const EXTENSIONS: &[&str] = &[
    "7z", "a", "avi", "bmp", "class", "dmg", "doc", "docx", "eot", "exe", "gif", "gz", "ico",
    "icns", "jar", "jpeg", "jpg", "mov", "mp3", "mp4", "o", "otf", "pdf", "png", "ppt", "pptx",
    "rar", "so", "tar", "ttf", "wav", "webm", "webp", "woff", "woff2", "xls", "xlsx", "zip",
];
